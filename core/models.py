...
class Customer(models.Model):
    ...
    def __str__(self):
        return self.user.get_full_name() # This line is to determine the value to show in Admin Dashboard
...
class Job(models.Model):
    ...
    # Step2: New Fields Added to the Database for PICKUP
    ...
    # Step 3:  # New Fields Added to the Database
